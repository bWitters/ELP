...
var $author$project$Main$Model = F3(
	function (name, draw, content) {
		return {content: content, draw: draw, name: name};
	});
...
var $author$project$Parsing$executeInstructions = F2(
	function (instructions, state) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (instruction, _v5) {
					var currentState = _v5.a;
					var accPoints = _v5.b;
					var _v6 = A2($author$project$Parsing$updateState, instruction, currentState);
					var newState = _v6.a;
					var newPoints = _v6.b;
					return _Utils_Tuple2(
						newState,
...
var $author$project$Parsing$updateState = F2(
	function (instruction, state) {
		switch (instruction.$) {
			case 'Forward':
				var d = instruction.a;
				var rad = $elm$core$Basics$degrees(state.angle);
				var newY = state.position.b + (d * $elm$core$Basics$sin(rad));
				var newX = state.position.a + (d * $elm$core$Basics$cos(rad));
				var newPos = _Utils_Tuple2(newX, newY);
			...
			default:
				...
				var _v1 = A3(
					...
					F2(
						function (_v2, _v3) {
							var currentState = _v3.a;
							var accPoints = _v3.b;
							var _v4 = A2($author$project$Parsing$executeInstructions, instructions, currentState);
							var newState = _v4.a;
							var newPoints = _v4.b;
							return _Utils_Tuple2(
								newState,
				...
				var points = _v1.b;
				return _Utils_Tuple2(finalState, points);
		}
	});
...
var $author$project$Parsing$pForward = A2(
...
var $author$project$Parsing$pLeft = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$ignorer,
		A2(
...
var $author$project$Parsing$pRight = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$ignorer,
		A2(
...
function $author$project$Parsing$cyclic$pInstruction() {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				$author$project$Parsing$pForward,
				$author$project$Parsing$pLeft,
				$author$project$Parsing$pRight,
				$author$project$Parsing$cyclic$pRepeat()
			]));
}
function $author$project$Parsing$cyclic$pInstructionList() {
	return $elm$parser$Parser$sequence(
		{
			end: '',
			item: $elm$parser$Parser$lazy(
				function (_v1) {
					return $author$project$Parsing$cyclic$pInstruction();
				}),
			separator: ',',
...
function $author$project$Parsing$cyclic$pRepeat() {
	return A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
		...
		A2(
			...
			A2(
				...
				$elm$parser$Parser$lazy(
					function (_v0) {
						return $author$project$Parsing$cyclic$pInstructionList();
					}),
				$elm$parser$Parser$spaces),
			$elm$parser$Parser$symbol(']')));
}
try {
	var $author$project$Parsing$pInstruction = $author$project$Parsing$cyclic$pInstruction();
	$author$project$Parsing$cyclic$pInstruction = function () {
		return $author$project$Parsing$pInstruction;
	};
	var $author$project$Parsing$pInstructionList = $author$project$Parsing$cyclic$pInstructionList();
	$author$project$Parsing$cyclic$pInstructionList = function () {
		return $author$project$Parsing$pInstructionList;
	};
	var $author$project$Parsing$pRepeat = $author$project$Parsing$cyclic$pRepeat();
	$author$project$Parsing$cyclic$pRepeat = function () {
		return $author$project$Parsing$pRepeat;
	};
} catch ($) {
	throw 'Some top-level definitions from `Parsing` are causing infinite recursion:\n\n  ┌─────┐\n  │    pInstruction\n  │     ↓\n  │    pInstructionList\n  │     ↓\n  │    pRepeat\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
var $author$project$Parsing$parser = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$ignorer,
		A2(
	...
	A2(
		...
		A2(
			$elm$parser$Parser$ignorer,
			A2($elm$parser$Parser$ignorer, $author$project$Parsing$pInstructionList, $elm$parser$Parser$spaces),
			$elm$parser$Parser$symbol(']')),
...
var $author$project$Parsing$read = function (input) {
	var _v0 = A2($elm$parser$Parser$run, $author$project$Parsing$parser, input);
	if (_v0.$ === 'Ok') {
		...
		var initialState = {
			...
			position: _Utils_Tuple2(250, 250)
		};
		var _v1 = A2($author$project$Parsing$executeInstructions, instructions, initialState);
		var points = _v1.b;
		return A2(
			$elm$core$List$cons,
...
var $author$project$Drawer$toSvgPoints = function (points) {
	return A2(
		$elm$core$String$join,
		' ',
		A2(
...
var $author$project$Drawer$viewSvg = function (points_to_draw) {
	return A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Drawer$toSvgPoints(points_to_draw)),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('field field_v1')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$class('field__input')
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						$author$project$Drawer$viewSvg(
						$author$project$Parsing$read(model.draw))
					]))
			]));
};
